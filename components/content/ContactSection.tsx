...
function ContactSection() {
  return (
    <section>
      <h2 className='text-2xl md:text-3xl my-6'>Vamos Garantir Seus Direitos?</h2>
      <p>
      ...
      <h2 className='text-2xl md:text-3xl my-6'>Entre em contato</h2>
      <p>
      ...
      <ul className='list-inside text-base md:text-lg md:ml-8 my-6'>
        <li className='my-2'>
          <Link
            ...
            target='_blank'
            passHref
            className='flex items-center hover:text- cursor-pointer'
          >
            <IoLogoWhatsapp size={32} className='text-[#112d3b]' />
            <span className='ml-1 md:ml-2'>18 99151-8387</span>
          </Link>
        </li>
