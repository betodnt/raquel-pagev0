  ...
  return (
    <section>
      ...
      <p className="text-2xl md:text-xl">
        Se você precisa de orientação jurídica, esclarecimento de dúvidas ou
        busca proteger seus interesses legais, conte comigo! Juntos, vamos
        trilhar o caminho da justiça e assegurar seus direitos.
      </p>
      <h2 className="text-3xl my-6 font-bold">Entre em contato</h2>
      <p className="text-2xl md:text-xl">
        Estou à disposição para ajudá-lo a navegar pelo mundo jurídico. Entre em
        contato comigo por qualquer um dos seguintes meios:
      </p>
